...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <!--  <div class="user-panel">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="{{Request::is('kategory')?'active':''}}"><a href="{{url('kategory')}}"><i class="fa fa-tags"></i> <span>@lang('RW')</span></a></li>
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2021 AdminLTE</a>.</strong> All rights reserved.
    </footer>
